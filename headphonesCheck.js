    ...
    this.htmlElements = {
      huggins: {
        instruction: '<p class="notice">现在我们来检查您的耳机</p>' +
            ...
            '<p>您的任务是确定三种噪音中的哪一种包含哔哔声，然后单击正确的按钮: <b>1</b>, <b>2</b>, or <b>3</b>.</p>' +
            '<p>点击 <span style="color:#03a9f4;"><b>蓝色</b></span> 按钮播放音频. 哔哔声隐藏在第二个噪音中，所以答案是 <b>2</b>.' +
            '    您可以根据需要多次播放该示例</p>' +
        ...
        checkPage: '<p class="notice">注意：每段声音仅播放一次</p>' +
            '<p class="center">哪一段噪音中隐藏了哔哔声? 是 <b>1</b>, <b>2</b>, 还是 <b>3</b>?</p>',
      },
      beat: {
